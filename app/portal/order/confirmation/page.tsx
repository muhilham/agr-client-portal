...
function PaymentInstructions({ orderNumber, grandTotal }: { orderNumber: string; grandTotal: number }) {
  ...
  const waUrl = getWhatsAppUrl({ orderNumber, grandTotal })
  ...
  return (
    <div className="w-full rounded-xl border border-[rgba(245,235,201,0.25)] bg-brand-midnight overflow-hidden">
      ...
      <div className="px-5 py-4 flex flex-col gap-4">
        ...
        {/* WhatsApp CTA */}
        {waSent ? (
          <div className="w-full rounded-lg bg-emerald-900/50 border border-emerald-700 px-4 py-3 text-center">
            <p className="text-emerald-200 text-sm font-medium">✅ Pesan terkirim!</p>
            <p className="text-emerald-300/70 text-xs mt-1">Kami akan segera memproses pesanan Anda setelah transfer terkonfirmasi.</p>
          </div>
        ) : (
          <a
            href={waUrl}
  ...
  return (
    <main className="min-h-screen bg-brand-black flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm flex flex-col items-center gap-6 text-center">
        ...
        {/* Success card — secondary, smaller */}
        <div
