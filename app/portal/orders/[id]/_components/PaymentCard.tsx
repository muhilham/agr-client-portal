      ...
      <div className="rounded-xl border border-[rgba(245,235,201,0.25)] bg-brand-midnight overflow-hidden">
        ...
        <div className="px-5 py-4 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-brand-honey text-lg font-semibold" data-testid="payment-grand-total">
            ...
            <div key={bank} className="flex flex-col gap-1">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs text-brand-parchment underline hover:text-brand-crema transition-colors"
                  data-testid={`copy-account-${bank.replace(/\s/g, '-').toLowerCase()}`}
                >
          ...
          <p className="text-brand-parchment text-xs text-center leading-relaxed">
